...
import { ArrowLeft, Clock, MapTrifold } from "@phosphor-icons/react";
          ...
          <div className="grid h-screen grid-cols-[1fr_380px] items-start gap-8">
            ...
            <div className="sticky top-0 divide-y-2 divide-dashed divide-foreground-200 py-4">
              <div className="pb-6">
                ...
                <div className="flex items-center justify-center gap-2 rounded-xl border-[2px] border-amber-500 bg-amber-600/20 p-2 text-sm font-semibold text-amber-500">
                  <Clock weight="bold" size={20} className="text-amber-500" />
                  Belum Dibayar
                </div>
              </div>

              <p className="pt-4 text-sm italic text-foreground-600">
                <span className="font-semibold text-foreground">Catatan:</span>{" "}
                Pembeli belum melakukan pembayaran sesuai nominal yang tertera.
              </p>
            </div>
          </div>
        </section>
